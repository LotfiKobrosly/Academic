...
public class DrawPointSet {
	...
	public void drawPoint(Point_3 p) {
		...
		float x1=(float)p.x.doubleValue()*s;
		float y1=(float)p.y.doubleValue()*s;
		float z1=(float)p.z.doubleValue()*s;
	...
	public void drawNormal(Point_3 p, double[] n) {
		...
		float x1=(float)p.x.doubleValue();
		float y1=(float)p.y.doubleValue();
		float z1=(float)p.z.doubleValue();
	...
	public void drawSegment(Point_3 p, Point_3 q, float[] color) {
		...
		float y1=(float)p.y.doubleValue()*s;
		float z1=(float)p.z.doubleValue()*s;
		float x2=(float)q.x.doubleValue()*s;
		float y2=(float)q.y.doubleValue()*s;
		float z2=(float)q.z.doubleValue()*s;
